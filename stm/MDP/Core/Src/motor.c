...
//This is for distance away (US sensor wise)
...
{
	__HAL_TIM_SetCompare(motor_pwm_tim, L_CHANNEL,value);
	__HAL_TIM_SetCompare(motor_pwm_tim, R_CHANNEL,value);
}
