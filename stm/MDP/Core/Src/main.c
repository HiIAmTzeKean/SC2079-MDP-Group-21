...
//  magcal_calc_params();
  ...
  sensors_set_bias(625); 		// set initial bias. 625 was working for us
...
//	y += motor_getDist() * sinf(headingRads);

//	sprintf(xyOled, "X: %.2f Y: %.2f head: %.2f", x,y,heading);
//	OLED_ShowString(0,10,xyOled);
//	OLED_Refresh_Gram();
	/* ----- End: Sensor reading ----- */
